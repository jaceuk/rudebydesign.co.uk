		...
		<header id="masthead" class="site-header">
			<div class="inner-wrapper">
				<div class="site-branding">
					...
					$rude_by_design_description = get_bloginfo('description', 'display');
					if ($rude_by_design_description || is_customize_preview()) :
					?>
						<p class="site-description"><?php echo $rude_by_design_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
																				?></p>
					<?php endif; ?>
				</div><!-- .site-branding -->
