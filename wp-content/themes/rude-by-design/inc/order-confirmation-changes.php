...
function personalisation($order_id)
{
	...
	<p>If your order contains a personalised item that requires a photo you\'ll need to email your photo along with your order number to info@rudebydesign.co.uk.</p>
